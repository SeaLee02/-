<%@ WebHandler Language="C#" Class="FunctionDemo.Web.Login.verify_code" %>

using System;
using System.Web;
using System.Drawing;
using System.IO;
using System.Web.SessionState;  //可以对Session设置

namespace FunctionDemo.Web.Login
{
    //IRequiresSessionState    可以进行Session设置，如果不引用，就不能设置Session
