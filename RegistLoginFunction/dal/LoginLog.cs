...
namespace FunctionDemo.DAL
{
    ...
    public partial class LoginLog
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Model.LoginLog model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LoginLog(");
            strSql.Append("UserID,LoginTime,Remark)");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Model.LoginLog model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Model.LoginLog GetModel(int ID)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,UserID,LoginTime,Remark from LoginLog ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
                    new SqlParameter("@ID", SqlDbType.Int,4)
            };
            ...
            Model.LoginLog model = new Model.LoginLog();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Model.LoginLog DataRowToModel(DataRow row)
        {
            Model.LoginLog model = new Model.LoginLog();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,UserID,LoginTime,Remark ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" ID,UserID,LoginTime,Remark ");
            strSql.Append(" FROM LoginLog ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
